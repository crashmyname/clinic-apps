        ...
        <div class="LoginFormContainer">
          <div class="LoginFormInnerContainer">
            <div class="LogoContainer">
              <img src="{{asset('img/HRM.png')}}" width="65%" class="logo"><img src="{{asset('img/ise.png')}}" class="logo">
            </div>
            <header class="header">Log in</header>
            <header class="subHeader">Welcome to <b>Clinic System</b> Please Login Before Access The Applications</header>
            @if (count($errors) > 0)
            ...
            <form action="{{route('regist')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="{{asset('img/Hn13wvm.png')}}" class="labelIcon"><span>Nama*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="name">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="{{asset('img/Hn13wvm.png')}}" class="labelIcon"><span>Level*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="level">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="{{asset('img/Hn13wvm.png')}}" class="labelIcon"><span>Foto*</span></label>
                <input type="file" name="foto">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="{{asset('img/Hn13wvm.png')}}" class="labelIcon"><span>Username*</span></label>
                <input type="text" class="input" id="empId" placeholder="Enter your Username" name="email">
              </div>
              <div class="inputContainer">
                <label class="label" for="emailAddress"><img src="{{asset('img/g5SvdfG.png')}}" class="labelIcon"><span>Password*</span></label>
                <input type="password" class="input" id="PassId" placeholder="Enter your Password" name="password">
              </div>
